...
public class JournalAppGUI extends JFrame {
    ...
    public JournalAppGUI(Group group) {
        ...
        JButton btnAddStudent = new JButton("1 - Додати студента");
        JButton btnAddGroupDiscipline = new JButton("2 - Додати дисципліну в групу");
        JButton btnAddDiscipline = new JButton("3 - Додати дисципліну студенту");
        JButton btnAddGrade = new JButton("4 - Виставити оцінку студенту");
        JButton btnViewStudentPerformance = new JButton("5 - Переглянути успішність студента");
        JButton btnViewGroupReport = new JButton("6 - Переглянути звіт групи");
        JButton btnDelete = new JButton("7 - Видалення");
        JButton btnViewAllGrades = new JButton("8 - Переглянути всі оцінки всіх студентів");
        JButton btnExit = new JButton("0 - Вийти");
